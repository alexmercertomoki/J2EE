...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.salesRanking.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as data]
				<tr>
					...
					<td>
						<span title="${data[0].fullName}">${abbreviate(data[0].fullName, 50, "...")}</span>
					</td>
					<td>
						${data[1]}
					</td>
					<td>
						${currency(data[2], true)}
					</td>
				</tr>
			[/#list]
		</table>
